...
["name", "Chaos Insurgency"] call _fnc_saveToTemplate;
["nameLeader", "The Engineer"] call _fnc_saveToTemplate;
...
_loadoutData set ["NVGs", ["dvk_corp_gasmask", "dvk_corp_gasmask_b2"]];
...
_loadoutData set ["offuniforms", ["dvk_corp_up_u"]];
_loadoutData set ["vests", ["CUP_V_B_Armatus_Black"]];
_loadoutData set ["heavyVests", ["Vest_Thor_Rifleman_Black"]];
_loadoutData set ["atBackpacks", ["B_Carryall_blk"]];
_loadoutData set ["backpacks", ["B_AssaultPack_blk"]];
_loadoutData set ["helmets", ["dvk_corp_hblack"]];
...
_loadoutData set ["rifles", [// Fort 224
	["CUP_arifle_Fort224_Grippod", "CUP_muzzle_mfsup_Flashhider_545x39_Black", "ACE_DBAL_A3_Red", "CUP_optic_AIMM_MICROT1_BLK",  ["CUP_30Rnd_545x39_Fort224_M"], [], ""]
]];
_loadoutData set ["tunedRifles", [// l98-a6 H
	["WBK_EPSM_Scar_1_Black", "ACE_muzzle_mzls_L", "ACE_DBAL_A3_Red", "CUP_optic_AIMM_MICROT1_BLK",  ["Magazine_30rnd_556Scar_Black"], [], ""]
]];
_loadoutData set ["enforcerRifles", [//M4 beowulf, XTS
	["CUP_arifle_M4_MOE_BW", "", "ACE_DBAL_A3_Red", "CUP_optic_AIMM_MICROT1_BLK", ["CUP_10Rnd_50BW_Mag_M4_M"], [], ""],
	["DSA_XTS", "", "", "rhsusf_acc_anpas13gv1", ["DSA_10Rnd_XTS_Mag", "DSA_10Rnd_XTS_slug_Mag", "DSA_10Rnd_XTS_HEAP_Mag"], [], ""]
]];
_loadoutData set ["carbines", [// P90
	["CUP_smg_p90_black", "muzzle_snds_570", "ACE_DBAL_A3_Red", "CUP_optic_AIMM_MICROT1_BLK", ["50Rnd_570x28_SMG_03"], [], ""]
]];
_loadoutData set ["grenadeLaunchers", [//groza
	["CUP_arifle_OTS14_GROZA_762_GL", "", "", "", ["CUP_30Rnd_762x39_AK47_M"], ["rhs_VOG25", "rhs_VOG25", "rhs_VOG25P", "rhs_GRD40_White"], ""]
]];
_loadoutData set ["machineGuns", [//minimi para
	["CUP_lmg_minimipara", "ACE_muzzle_mzls_L", "", "", ["CUP_200Rnd_TE4_Red_Tracer_556x45_M249"], [], ""]
]];
_loadoutData set ["marksmanRifles", [// WRS 28 Pilum
	["WRS_Weapon_Sniper_URBAN", "", "", "ACE_optic_SOS_PIP", ["WRS_Sniper_Magazine", "WRS_Sniper_Magazine_AP"], [], ""]
]];
